...
<head>
    ...
    <title>Rides Managment Page</title>
...
<body>
    ...
    $ride_sql = "SELECT ride.ride_id, ride.ride_to, ride.ride_from, ride.status, ride.time, ride.seats_available, driver.name AS driver_name
                    FROM ride
    ...
    <h1 class="text-3xl text-center p-4 text-gray-800">Rides List</h1>
    ...
    <script>
        ...
        var rideIdToDelete; // Variable to store the ride ID
        ...
        function Delete() {
            ...
            if (rideIdToDelete) {
                ...
                window.location.href = "actions/delete_ride.php?id=" + rideIdToDelete;
            } else {
